...
router.get('/get_esrc_list', async(req, res) => {
    ...
    let sql = "select * from t_esrc_fe_mold where spare_code like :spare_code and plant like :plant"
    try {
...
router.get('/get_location', async(req, res) => {
    ...
    let sql = "select * from t_esrc_fe_location where location_code like :location_code and plant like :plant"
    try {
        const data = await db.sequelize.query(sql, {
...
router.get('/get_location/:id', async(req, res) => {
    ...
    let sql = "select * from t_esrc_fe_location where id = :id"
    const data = await db.sequelize.query(sql, {
        replacements: { id: id },
        type: QueryTypes.SELECT
    });
...
router.delete('/delete_location/:id', async(req, res) => {
    const id = req.params.id
    let sql = "delete from t_esrc_fe_location where id = :id"
    const data = await db.sequelize.query(sql, {
        replacements: { id: id },
...
router.put('/update_location/:id', async(req, res) => {
    ...
    let sql = "Update t_esrc_fe_location set  location_name = :location_name  where id = :id"
    const data = await db.sequelize.query(sql, {
...
router.post('/post_location', async(req, res) => {
    ...
    let sql = "insert into t_esrc_fe_location (location_code,location_name,plant) values (:location_code,:location_name,:plant)"
    const data = await db.sequelize.query(sql, {
...
router.get('/get_esrc_list/:id', async(req, res) => {
    const id = req.params.id
    let sql = "select * from t_esrc_fe_mold where id = :id"
    const data = await db.sequelize.query(sql, {
        replacements: { id: id },
        type: QueryTypes.SELECT
    });
...
router.put('/update_esrc_list/:id', uploadFileMiddleware, async(req, res) => {
    ...
    if (req.file) {
        ...
        sql = "Update t_esrc_fe_mold set plant = :plant, spare_code = :spare_code, description = :description, price = :price, safe_stock = :safe_stock, type = :type, reg_empno = :reg_empno , picture = :filename where id = :id"
        ...
        sql = "Update t_esrc_fe_mold set plant = :plant, spare_code = :spare_code, description = :description, price = :price, safe_stock = :safe_stock, type = :type, reg_empno = :reg_empno where id = :id"
        const [results, metadata] = await db.sequelize.query(sql, {
...
router.delete('/delete_esrc_list/:id', async(req, res) => {
    const id = req.params.id
    const sql = "delete t_esrc_fe_mold where id = :id"
    const data = await db.sequelize.query(sql, {
        replacements: { id: id },
        type: QueryTypes.DELETE
    })
...
router.post('/post_esrc_list', uploadFileMiddleware, async(req, res) => {
    ...
    const reg_empno = req.body.reg_empno
    const file = req.file
    let sql = "insert into t_esrc_fe_mold (spare_code,description,price,safe_stock,type,plant,picture,reg_empno)" +
...
router.get('/get_inout_list/:id', async(req, res) => {
    const id = req.params.id
    let sql = "select a.id,a.reg_empno,a.spare_code,b.type,b.description,a.purpose,a.po,a.reg_date,a.qty,a.location from t_esrc_fe_inout as a join t_esrc_fe_mold as b on a.spare_code = b.spare_code join t_esrc_fe_location as c on a.location = c.location_code where a.id = :id"
    const data = await db.sequelize.query(sql, {
        replacements: { id: id },
        type: QueryTypes.SELECT
    })
...
router.post('/post_inout_gr', async(req, res) => {
    ...
    let sql = "insert into t_esrc_fe_inout (spare_code,purpose,po,movement,location,qty,reg_empno,reg_date) values (:spare_code,:purpose,:po,:movement,:location,:qty,:reg_empno,:reg_date)"
    const data = await db.sequelize.query(sql, {
...
router.post('/post_inout_stock', async(req, res) => {
    ...
    const location_code = req.body.location_code
    const qty = req.body.qty
    let sql = "insert into t_esrc_fe_stock (spare_code,location_code,qty) values(:spare_code,:location_code,:qty)"
    const data = await db.sequelize.query(sql, {
