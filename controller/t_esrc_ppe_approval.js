...
router.get('/get_ppe_carry/:id', async(req, res) => {
    ...
    let sql2 = "select a.*,(select usrnm from t_user as b where a.carrier = b.usrid) as carrier_name ,(select usrnm from t_user as b where a.reg_no = b.usrid) as reg_name from t_esrc_ppe_carry as a where id = :id"
